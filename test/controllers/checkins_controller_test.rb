...
class CheckinsControllerTest < ActionController::TestCase
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post :create, checkin: { first_input: @checkin.first_input, second_input: @checkin.second_input, third_input: @checkin.third_input }
    end
  ...
  test "should update checkin" do
    patch :update, id: @checkin, checkin: { first_input: @checkin.first_input, second_input: @checkin.second_input, third_input: @checkin.third_input }
    assert_redirected_to checkin_path(assigns(:checkin))
  end
